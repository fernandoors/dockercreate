    ...
    <Container>
      ...
      <Collapse accordion>
        <Panel header="How to install docker?" key="1">
          <Tabs defaultActiveKey="1">
            <TabPane tab="Windows" key="1">
              <p>
                To install docker on Windows, download and install Docker
                Desktop Hub&nbsp;
              ...
              <br />
              <br />
              <small htmlFor="PS. Docker for Windows require Windows 10 Professional or Enterprise 64bit.">
                PS. Docker for Windows require Windows 10 Professional or
                Enterprise 64bit.
              </small>
            </TabPane>
            <TabPane tab="Mac" key="2">
              ...
              <br />
              <br />
              After install, the Docker menu in the top status bar indicates
              that Docker Desktop is running, and accessible from a terminal.
              <br />
              <br />
        ...
        <Panel header="How to build?" key="2">
          <p>
            Builder image is used to create or update your container with last
        ...
        <Panel header="How to access container Bash?" key="5">
          ...
          <CliStyle
            onClick={() =>
              handleCopy("docker exec -i -t <my_container_id> /bin/bash")
            }
        ...
        <Panel header="How to exec shell commands?" key="6">
          ...
          <CliStyle
            onClick={() =>
              handleCopy("docker exec -i -t <my_container_id> <command>")
            }
            htmlFor="Copy Command run shell command into the container"
          >
            {" "}
            docker exec -i -t {`<my_container_id>`} {`<command>`}
          </CliStyle>
        </Panel>
